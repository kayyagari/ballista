...
<template>
  <div class="bg-linear-to-tr from-indigo-900 to-teal-500 text-white flex flex-col justify-around items-center px-10">
    <p class="text-center">
    ...
    <div class="flex flex-col gap-4 w-full">
      <nuxt-link
          v-for="(route, routeIndex) in routes" :key="routeIndex"
          :to="route.to"
